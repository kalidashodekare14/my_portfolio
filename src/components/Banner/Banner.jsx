...
const Banner = () => {
    ...
    return (
        <div id='home' className='overflow-hidden relative bg-black  bg-grid-pattern dark:bg-grid-pattern-dark bg-grid  dark:bg-white flex flex-row justify-center items-center space-y-10  py-20  lg:px-20'>
