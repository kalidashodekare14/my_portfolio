...
const AboutMe = () => {
    ...
    return (
        <section id='about' className=' bg-[#110f17] dark:bg-white min-h-screen py-5 pt-20'>
            <div className='lg:mx-32 lg:my-10 flex flex-col lg:flex-row justify-between items-center lg:space-x-10 space-y-3'>
                ...
                <div data-aos="fade-right" data-aos-delay="1000" className='mx-3 lg:w-[50%]  text-white dark:text-black space-y-5 font-rubik'>
